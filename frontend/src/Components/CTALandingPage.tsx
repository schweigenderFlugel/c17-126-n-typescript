...
export const CTALandingPage = () => {
  return (
    <section className="relative flex bg-indigo-600 mx-48 max-sm:mx-4 max-lg:mx-24 my-12 p-12 max-sm:p-8 rounded-3xl max-lg:h-[800px] max-xl:h-[700px] text-white overflow-hidden">
      <div className="h-[400px]">
        <img
          className="top-0 max-2xl:top-[10%] max-xl:top-auto -right-[10%] max-xl:right-0 max-[500px]:bottom-[75%] max-[850px]:bottom-[60%] max-xl:bottom-[65%] absolute max-xl:p-5 w-[50%] max-xl:w-full h-auto max-xl:scale-150 scale-150"

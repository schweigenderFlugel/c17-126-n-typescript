...
export const UploadImage = ({ avatar, file, onChange, ...props }) => {
  ...
  const avatarFound = avatar === null 
    ? <HiUser className="text-[60px] rounded-full mt-6 mb-6 text-black dark:text-white hover:bg-indigo-600 dark:hover:bg-indigo-300 hover:text-white dark:hover:text-black hover:border hover:border-1 hover:border-black dark:hover:border-indigo-600"/> 
    : image(avatar)

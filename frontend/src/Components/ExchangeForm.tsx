  ...
  return (
    <div className="flex flex-col justify-between border-indigo-300 dark:border-indigo-600 dark:border-2 bg-indigo-100 dark:bg-indigo-950 shadow-lg p-4 border rounded-xl h-full dark:text-white">
      ...
      <div className="flex items-center gap-2">
        <p className="border-emerald-500 px-2 py-1 border rounded-full text-emerald-500">
          +12.3%
        </p>
        <div className="border-emerald-500 p-1 border rounded-full text-emerald-500 text-xl">
          <HiArrowTrendingUp />
        </div>
      </div>

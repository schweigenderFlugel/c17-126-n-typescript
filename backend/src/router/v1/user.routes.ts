...
import { getUsersByAlias, userCreate, userUpdate } from '../../middlewares/validators/user.validator'
// CONTROLLERS
...
userRouter.post(
  '/all-alias',
  userAuth,
  schemaValidator(getUsersByAlias, null),
  userController.getUsersAlias,
  errorHandler,
)
...
userRouter.put(
  '/:id',
  userAuth,
  schemaValidator(userUpdate, null),
